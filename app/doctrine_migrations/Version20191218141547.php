...
final class Version20191218141547 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('UPDATE client set Username = CONCAT(CONCAT(email, \'-\'), CAST(CodCli AS CHAR(10)))');
        ...
        $this->addSql('UPDATE contact set Username = CONCAT(CONCAT(eMail, \'-\'), CAST(CodCo AS CHAR(10)))');
        ...
        $this->addSql('CREATE TABLE ligne_panier (panier INT DEFAULT NULL, idLPanier INT AUTO_INCREMENT NOT NULL, Qte INT NOT NULL, IdProd INT DEFAULT NULL, INDEX IDX_21691B4C1E54A3F (IdProd), INDEX IDX_21691B424CC0DF2 (panier), PRIMARY KEY(idLPanier)) DEFAULT CHARACTER SET UTF8 COLLATE `UTF8_unicode_ci` ENGINE = MyISAM');
        $this->addSql('ALTER TABLE ligne_panier CHANGE IdProd IdProd INT DEFAULT NULL');
        $this->addSql('ALTER TABLE tpays CHANGE CodPays CodPays VARCHAR(2) NOT NULL');
        $this->addSql('ALTER TABLE produit ADD UrlPartenaire LONGTEXT NOT NULL, ADD Genre CHAR(6) NOT NULL');
        $this->addSql('ALTER TABLE donr DROP CpteBanq, DROP AdBanq, DROP CPBanq, DROP VilBanq, DROP PaysBanq, CHANGE DonRCo DonRCo INT DEFAULT NULL, CHANGE ModDon ModDon VARCHAR(6) NOT NULL, CHANGE DatVir DatVir DATETIME NOT NULL, CHANGE VirFin VirFin DATETIME NOT NULL, CHANGE status status VARCHAR(10) NOT NULL');
        $this->addSql('CREATE INDEX CodDonR ON donr (CodDonR)');
        $this->addSql('DROP INDEX codco_l ON donr');
        $this->addSql('CREATE INDEX DonRCo ON donr (DonRCo)');
        $this->addSql('ALTER TABLE don CHANGE EnregDon EnregDon DATETIME NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ligne_panier DROP FOREIGN KEY FK_21691B4C1E54A3F');
        $this->addSql('ALTER TABLE ligne_panier CHANGE IdProd IdProd INT NOT NULL');
        $this->addSql('ALTER TABLE produit DROP UrlPartenaire, DROP Genre');
